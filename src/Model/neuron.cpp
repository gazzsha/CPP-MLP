...
namespace s21{ 
    ...
    GraphPreceptron::GraphPreceptron(const size_t& sz,const size_t& size_enter,const size_t& n,const size_t& output_size): size(sz),enter_layer(size_enter),output_layer(output_size) {
        for (size_t i = 0; i < sz; ++i) {
